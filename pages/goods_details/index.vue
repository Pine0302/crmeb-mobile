                        ...
                        <view class="coupon acea-row row-between-wrapper" v-if="activityH5.length">
                            <view class="line1 acea-row">
                                ...
                                <view v-for='(item,index) in activityH5' :key='index' @click="goActivity(item)">
                                    ...
                                    <view :class="index==0?'activity_pin':'' || index==1?'activity_miao':'' || index==2?'activity_kan':''"
                                        v-if="item.type === '2'">
                ...
                <view class="superior" if='good_list.length' id="past2">
                    ...
                    <view class="slider-banner banner">
                        <swiper indicator-dots="true" :autoplay="autoplay" :circular="circular" :interval="interval"
                            :duration="duration" indicator-color="#999" indicator-active-color="#e93323" :style="'height:'+clientHeight+'px'">
        ...
        methods: {
            ...
            getUserInfo: function() {
                ...
                getUserInfo().then(res => {
                    that.$set(that.sharePacket, 'isState', Math.floor(that.sharePacket.priceName) != 0 ?
                        false : true);
